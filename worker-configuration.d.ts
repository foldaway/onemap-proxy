/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7971894bc31cda1bc160dd5a8af5d706)
// Runtime types generated with workerd@1.20260312.1 2026-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OnemapCacheDurableObject";
	}
	interface Env {
		ONEMAP_EMAIL: string;
		ONEMAP_PASSWORD: string;
		API_TOKENS: string;
		ONEMAP_CACHE_DO: DurableObjectNamespace<import("./src/index").OnemapCacheDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ONEMAP_EMAIL" | "ONEMAP_PASSWORD" | "API_TOKENS">> {}
}
